  ...
  return (
    <div className="flex flex-col items-center " id="contact-me">
      ...
      <div className="flex flex-col md:flex-row md:w-full">
        ...
        />
        <button className="cursor-pointer whitespace-nowrap bg-primary text-white rounded-lg px-4 py-2 self-center  hover:bg-primary-hover focus:bg-primary-hover active:bg-primary-hover transition">
          Contact me
        </button>
      </div>
    </div>
